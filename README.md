إليك النسخة المعدلة من الـ **README** بعد إزالة الإيموجي، استبدالها برموز أيقونات نصية بسيطة (ASCII/Unicode)، وإضافة وصف للصور التي يمكن وضعها في مجلد `images/` (أو مجلد 1 كما طلبت).

يمكنك إنشاء مجلد باسم `images` داخل المشروع، ووضع الصور به (مثلاً: example1.png ، example2.png ، ... إلخ).
...
![مثال بطاقة اقتباس أرجواني](images/im1age.png)
